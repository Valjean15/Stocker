...
namespace Models.Inventory
{
    ...
    public class StockItem
    {
        ...
        /// <summary>
        /// <para>Propiedad virtual de la llave foranea de <see cref="StockId"/></para>
        /// <para>Indica a que almacen pertenece</para>
        /// </summary>
        public virtual Stock Stock { get; set; }

        /// <summary>
        /// <para>Propiedad virtual de la llave foranea de <see cref="BundleItemId"/></para>
        /// <para>Indica a que elemento de lote representa</para>
        /// </summary>
